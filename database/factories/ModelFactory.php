...
$factory->define(App\Models\PaymentChannel::class, static function (Faker\Generator $faker) {
    return [
...
/** @var  \Illuminate\Database\Eloquent\Factory $factory */
$factory->define(App\Models\AddressType::class, static function (Faker\Generator $faker) {
    return [
