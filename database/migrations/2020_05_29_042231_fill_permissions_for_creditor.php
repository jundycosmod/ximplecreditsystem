...
class FillPermissionsForCreditor extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCreditor constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.creditor',
            'admin.creditor.index',
            'admin.creditor.create',
            'admin.creditor.show',
            'admin.creditor.edit',
            'admin.creditor.delete',
            'admin.creditor.bulk-delete',
        ]);
