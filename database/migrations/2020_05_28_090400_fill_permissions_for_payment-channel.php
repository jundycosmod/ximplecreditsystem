...
class FillPermissionsForPaymentChannel extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPaymentChannel constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.payment-channel.index',
            'admin.payment-channel.create',
            'admin.payment-channel.show',
            'admin.payment-channel.edit',
            'admin.payment-channel.delete',
            'admin.payment-channel.bulk-delete',
        ]);
