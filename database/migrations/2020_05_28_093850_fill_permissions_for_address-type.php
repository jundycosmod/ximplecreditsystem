...
class FillPermissionsForAddressType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAddressType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.address-type',
            'admin.address-type.index',
            'admin.address-type.create',
            'admin.address-type.show',
            'admin.address-type.edit',
            'admin.address-type.delete',
            'admin.address-type.bulk-delete',
        ]);
